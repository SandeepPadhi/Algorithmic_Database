...
class Billing{
    ...
    protected:
        unordered_map<string,int> product_rate;
        unordered_map<string,int> product_unit;
    public:
        ...
        void getbill(){
            ...
            for(unordered_map<string,pair<int,int>>::iterator a=cart.begin();a!=cart.end();a++){
                string prod=a->first;
